...
| F446RE 핀 | 커넥터 위치 | SN65HVD230 핀 | 신호 |
|-----------|------------|---------------|------|
| **PA12** | CN10 | TXD | CAN1_TX |
| **PA11** | CN10 | RXD | CAN1_RX |
| **3.3V** | CN6 pin 4 또는 CN10 | VCC | 전원 |
| **GND** | CN6 pin 6 또는 CN10 | GND | 기준 전위 |
| (선택) | — | RS → GND | 고속 모드 (필요 시) |

- [ ] PA12 ↔ SN65HVD230 TXD 연결
- [ ] PA11 ↔ SN65HVD230 RXD 연결
- [ ] 3.3V ↔ SN65HVD230 VCC 연결
- [ ] GND ↔ SN65HVD230 GND 연결
- [ ] (해당 시) RS ↔ GND 연결
...
```
SN65HVD230 CANH ──── 브레드보드 CANH 열 ──── MCP2515 모듈 CANH
SN65HVD230 CANL ──── 브레드보드 CANL 열 ──── MCP2515 모듈 CANL
```

- [ ] SN65HVD230 CANH ↔ MCP2515 모듈 CANH 연결 (브레드보드 경유)
- [ ] SN65HVD230 CANL ↔ MCP2515 모듈 CANL 연결 (브레드보드 경유)
- [ ] **F446RE GND ↔ F411RE GND 공통 연결** ← 이것이 없으면 차동 신호 기준이 달라져 통신 불가
