...
│   ├── ioc_f446re_phase0.md   # F446RE Phase 0 CubeMX 설정
│   └── lesson_learned.md      # 부모 프로젝트의 사고 회고 + 사전 회피 사례
├── firmware/
│   ├── f446re_node/
│   │   ├── phase0_alive/      # LED 점멸 + UART "alive"
│   │   ├── phase1_loopback/   # bxCAN 내부 루프백
│   │   └── phase2_two_node/   # F411RE와의 2노드 통신
│   └── f411re_node/
│       ├── phase0_alive/
│       ├── phase1_loopback/
│       └── phase2_two_node/
...
F446RE의 CubeMX 설정은 [`docs/ioc_f446re_phase0.md`](docs/ioc_f446re_phase0.md) 참조.
